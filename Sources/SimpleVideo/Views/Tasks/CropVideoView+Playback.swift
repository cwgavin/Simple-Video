...
extension CropVideoView {
    ...
    func preparePreviewProxyFallback(for path: String) {
    ...
    func nudgeSelectedTrimHandle(byFrames frames: Int) {
    ...
    func minimumTrimDuration(for duration: Double) -> Double {
        0.1
    }

    func loadFrameDuration(from asset: AVURLAsset) async throws -> Double? {
